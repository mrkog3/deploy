...
import Logo from "../../../public/Tooxsai-Logo.png";
const Chat = () => {
                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            <img src={Logo} alt="Chat logo" className={styles.chatLogo} />
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput clearOnSend placeholder="Escribe una pregunta" disabled={isLoading} onSend={question => makeApiRequest(question)} />
                    </div>
                </div>
